...
def create_lmdb_for_mine():
    ...
    """
    # HR images
    folder_path = '/home/dircon/seoyun2/Dacon_SR/train/hr'
    lmdb_path = '/home/dircon/hoeyeong/HAT/datasets/train/hr.lmdb'
    img_path_list, keys = prepare_keys_mine(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx4 images
    folder_path = '/home/dircon/seoyun2/Dacon_SR/train/lr'
    lmdb_path = '/home/dircon/hoeyeong/HAT/datasets/train/lr.lmdb'
    img_path_list, keys = prepare_keys_mine(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)


def prepare_keys_mine(folder_path):
    """Prepare image path list and keys for DIV2K dataset.
    Args:
        folder_path (str): Folder path.
    Returns:
